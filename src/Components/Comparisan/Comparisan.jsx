...
function Comparisan() {
  return (
    ...
    <div style={{ backgroundColor: "#e9ecef" }}>
      <h4 className='offset-1 pt-5'>Comparison of Realme Note 50 with  Xiaomi Redmi 13C</h4>
      <div className='d-flex flex-row justify-content-around offset-1 mb-5' style={{ backgroundColor: "white", width:'80%'}}>
        <div className='mt-5'>
