...
const Performance = ({ selectedMobileId1,selectedMobileId2,selectedMobileId3,selectedMobileId4 }) => {
 ...
 if (!mobileData) {
  const data = [
  ['Processor', 'Unisoc Tiger T612', 'Media Tek Helio G85','', ''],
    ...
    <div className='mx-lg-5'>
      ...
      <tr>
          ...
          <tr>
            ...
            <td>{mobileData4 && mobileData4.data ? mobileData4.data.gpu : ' '}</td>
          </tr>
</tbody>
      </table>
    </div>
