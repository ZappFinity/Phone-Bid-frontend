  ...
  return (
    <>
      ...
      <div className='greyColor'>
        {name && image && price ? (
            <div className="p-5">
          <div className='d-flex flex-row bg-white col-md-7 p-5 offset-3'>
            <img src={image} className="col-sm-3 offset-2"/>
          ...
          <Link to='/accessories'><button className="btn greenColor text-white">Continue</button></Link>
            </div>
          </div>
          </div>
        ) : (
