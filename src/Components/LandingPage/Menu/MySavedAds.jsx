  ...
  return (
    ...
    <div style={{ backgroundColor: "#e9ecef" }}>
        ...
        <div className="bg-white offset-1" style={{border: '1px solid lightgrey', borderRadius: '5px'}}>
            ...
            >
              <Link to='/myads' type="button" class="btn hov text-secondary"
       ...
       <div
           ...
           <div className='mx-5 '>
            <h5 className='text-center mb-4 mt-3'  style={{color: "#52AB98"}}>You have not saved any ad</h5>
            <h6 style={{color: "#52AB98"}}>What are Saved Ads?</h6>
            <p>Saved ads features allows you to save ads that you might be insterested
             ...
             <h6 style={{color: "#52AB98"}}>How to save an Ad?</h6>
