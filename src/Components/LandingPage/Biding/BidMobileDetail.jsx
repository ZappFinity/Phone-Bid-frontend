      ...
      {mobiledetail && mobiledetail.data ? (
        ...
        <div className="d-flex flex-row p-4 gap-2 justify-content-center">
          ...
          >
            ...
            <p>
              PhoneBid’s Take The {mobiledetail.data.name} is a well-rounded mid-range
              smartphone offering excellent value with its sleek design, vibrant {" "}
              {mobiledetail.data.screen_size} display, and capable performance powered by a
              MediaTek processor and {mobiledetail.data.ram} of RAM. Its {mobiledetail.data.back_camera}  main camera,
              accompanied by ultra-wide and macro lenses, captures detailed
              photos, while the {mobiledetail.data.front_camera} front camera excels in selfies. Battery
              life is impressive, with a {mobiledetail.data.battery} capacity and 33W fast charging.
              Running on HiOS based on Android 12, it provides a customizable
              user experience, though with some pre-installed bloatware.
              Overall, the {mobiledetail.data.name} stands out for its display, camera
              versatility, performance, and battery life, making it a compelling
          ...
          >
            <div className="d-flex flex-row justify-content-between px-5 gap-3">
              ...
              <div className="d-flex flex-column py-3">
                <p>Seller <b>Waqar</b></p>
                <p>Ending <b>June 27 10:00 PM </b></p>
                <p>Bids <b>16</b></p>
                <p>Views <b>1200</b></p>
              </div>
              <div className="d-flex flex-column justify-content-center">
